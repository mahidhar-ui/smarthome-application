"""
SMARTHOME APPLICATION RAG Chatbot — Streamlit UI (TF-IDF version)
=====================================================
...
st.set_page_config(
    page_title="  SMARTHOME APPLICATION RAG CHATBOT Assistant",
    page_icon="💬",
    layout="centered"
)

st.title("SMARTHOME APPLICATION Internal Assistant")
st.caption("Ask anything about smarthome archtecture, devicemanagement,automation,security,troubleshooting, or api_data.")
st.divider()
...
def load_rag():
    ...
    for filename in sorted(os.listdir(DATA_FOLDER)):
        ...
        # Split document into 100-word chunks
    ...
    messages = [
        {
            "role": "system",
            "content": (
                "You are a helpful SMARTHOME APPLICATION RAG CHATBOT assistant. "
...
question = st.chat_input("Ask a question about SMARTHOME APPLICATIONS...")
